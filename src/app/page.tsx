        ...
        <section className="grid gap-12 rounded-3xl border border-base-300 bg-base-100 p-10 shadow-sm lg:grid-cols-2 lg:p-14">
          <article className="flex flex-col gap-5 text-left">
            ...
            <h2 className="font-semibold text-3xl lg:text-4xl">
              Modern rental search is fragmented
            </h2>
            <p className="text-base text-base-content/80 leading-relaxed">
              Listings live behind JavaScript-heavy maps, filters are buried in
              modal drawers, and exportable results are rare. Researchers and
              renters end up juggling spreadsheets, screenshots, and gut feel.
              Buscalo reframes the hunt as a conversation so you can brief one
              agent and get back real entries from real pages.
            </p>
            <ul className="list-disc space-y-2 pl-6 text-base-content/70 text-sm">
              <li>Noisy portals make it hard to compare neighborhoods fast.</li>
              <li>
                Manual navigation burns time when applying price, bed, and pet
                filters.
              </li>
              <li>
                Infinite-scroll grids rarely expose CSV or visual audit trails.
              </li>
            </ul>
          </article>

          <article className="flex flex-col gap-5 text-left">
            <span className="badge badge-outline badge-secondary w-fit">
              The Solution
            </span>
            <h2 className="font-semibold text-3xl lg:text-4xl">
              Voice-first browser automation
            </h2>
            <p className="text-base text-base-content/80 leading-relaxed">
              Buscalo pairs a GPT-5 powered agent with Browserbase Stagehand to
              act inside a real browser session. It applies filters, scrolls
              listings, captures screenshots, and stores structured data in
              Convex for live updates. You get a research teammate that explains
              every step and hands you exports within minutes.
            </p>
            <ul className="list-disc space-y-2 pl-6 text-base-content/70 text-sm">
              <li>
                Talk or tap-to-speak instructions, no rigid forms required.
              </li>
              <li>
                Infinite-scroll handling with deduped cards and geo heat maps.
              </li>
              <li>
                Artifacts, CSV, and JSON downloads for audit-ready sharing.
              </li>
            </ul>
          </article>
        </section>
        ...
        <section className="grid gap-6 rounded-3xl bg-gradient-to-br from-primary/10 via-base-100 to-secondary/10 p-10 shadow-sm lg:grid-cols-3 lg:p-14">
          <div className="flex flex-col gap-4 rounded-2xl bg-base-100/80 p-6 shadow">
            <div className="flex items-center gap-3">
              ...
              <h3 className="font-semibold text-xl">Next.js + Convex</h3>
            </div>
            <p className="text-base-content/70 text-sm leading-relaxed">
              Full-stack reactivity keeps the studio UI in sync with
              long-running agent jobs. Convex stores sessions, job state,
              artifacts, and streaming execution logs.
            </p>
          </div>
          <div className="flex flex-col gap-4 rounded-2xl bg-base-100/80 p-6 shadow">
            <div className="flex items-center gap-3">
              ...
              <h3 className="font-semibold text-xl">Stagehand + Browserbase</h3>
            </div>
            <p className="text-base-content/70 text-sm leading-relaxed">
              Browser-native automation drives JS-heavy map UIs, applies
              filters, scrolls lists, and extracts schema-validated listings
          ...
          <div className="flex flex-col gap-4 rounded-2xl bg-base-100/80 p-6 shadow">
            <div className="flex items-center gap-3">
              ...
              <h3 className="font-semibold text-xl">
                GPT-5 Agent Orchestration
              </h3>
            </div>
            <p className="text-base-content/70 text-sm leading-relaxed">
              Multi-tool reasoning selects actions—from natural language
              planning to Playwright commands—while logging each step for
        ...
        <section className="grid gap-10 rounded-3xl border border-base-300 bg-base-100 p-10 shadow-sm lg:grid-cols-[1.1fr_1fr] lg:p-14">
          <div className="flex flex-col gap-6">
            ...
            <h2 className="font-semibold text-3xl">
              How Buscalo finds and curates rentals
            </h2>
            <div className="rounded-2xl bg-base-200/60 p-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-lg">Find Rentals Flow</h3>
                  <p className="text-base-content/70 text-sm">
                    Voice briefs like “Jersey City studios under $2,000 with
                    pets” kick off a Browserbase session. The agent navigates,
                    applies filters, scrolls, and pulls rich listing cards with
            ...
            <div className="rounded-2xl bg-base-200/60 p-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-base-content/70 text-sm">
                    Live listings stream into the control room, where heat
                    overlays, tables, CSV, and JSON exports help you vet
                    neighborhoods and share findings instantly.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col gap-6 rounded-2xl bg-base-200/60 p-6 lg:p-10">
            ...
            <ul className="space-y-4 text-base-content/70 text-sm">
              <li>
                <strong className="text-base-content">Live agent log:</strong>{" "}
                status badges, screenshots, and retries streamed from Convex.
              </li>
              <li>
                <strong className="text-base-content">
                  Live listings table:
                </strong>{" "}
                sortable cards update as the agent scrapes fresh results from
                the target site.
              </li>
              <li>
                <strong className="text-base-content">
                ...
                CSV/JSON links and supporting screenshots for every run.
              </li>
              <li>
                <strong className="text-base-content">
                  Fallback demo mode:
                </strong>{" "}
                if a target site resists automation, a demo map showcases the
                workflow.
              </li>
            </ul>
